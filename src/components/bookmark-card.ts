...
const styles = {
  ...
  pinBadge:
    'absolute left-3 top-3 size-1.5 rounded-full bg-violet-300 shadow-[0_0_10px_rgba(196,181,253,0.8)]',
  actions:
    'absolute right-2 top-2 hidden text-violet-200 group-hover:block [&_svg]:size-4',
};
